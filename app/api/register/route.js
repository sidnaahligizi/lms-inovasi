...
export async function POST(req) {
  try {
    ...
    const cekSekolah = await masterTurso.execute({
    ...
    await masterTurso.execute(`CREATE TABLE IF NOT EXISTS Questions (QID TEXT PRIMARY KEY, ExamID TEXT, Tipe TEXT, Pertanyaan TEXT, Options TEXT, Key TEXT, Skor INTEGER, Nomor INTEGER, PembuatID TEXT)`);
    await masterTurso.execute(`CREATE TABLE IF NOT EXISTS Results (ResultID TEXT PRIMARY KEY, SiswaID TEXT, ExamID TEXT, TotalNilai TEXT, Detail TEXT, Pelanggaran TEXT, WaktuSubmit TEXT, Sekolah TEXT)`);
    await masterTurso.execute(`CREATE TABLE IF NOT EXISTS Attendance (AbsenID TEXT PRIMARY KEY, SiswaID TEXT, Tanggal TEXT, Status TEXT, Sekolah TEXT)`);
