...
export async function POST(req) {
  try {
    ...
    await turso.execute(`CREATE TABLE IF NOT EXISTS Tenants (TenantID TEXT PRIMARY KEY, NamaSekolah TEXT, Subdomain TEXT, AdminUsername TEXT, AdminPassword TEXT, Paket TEXT, MaxAdmin INTEGER, MaxGuru INTEGER, MaxSiswa INTEGER, DbUrl TEXT, DbToken TEXT, Logo TEXT)`);    
